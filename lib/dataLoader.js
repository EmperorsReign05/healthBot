...
export function recordToDocument(item, idx) {
  ...
  // Merge precaution columns if present
  const prevention = [
    pick('Prevention', 'precautions', 'Precautions', 'prevention'),
    pick('Precaution_1','precaution_1'),
    pick('Precaution_2','precaution_2'),
    pick('Precaution_3','precaution_3'),
    pick('Precaution_4','precaution_4'),
  ].filter(Boolean).join(' | ');
